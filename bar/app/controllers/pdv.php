...
// Carrega o PDV
	public function index(){	
		...
		$data['list_lanches'] 	 	= $this->crud_model->listar('produtos WHERE categoria = 1 ORDER BY nome ASC');
		$data['list_bebidas'] 	 	= $this->crud_model->listar('produtos WHERE categoria = 2 ORDER BY nome ASC');
		$data['list_porcoes']    	= $this->crud_model->listar('produtos WHERE categoria = 3 ORDER BY nome ASC');
		$data['list_kits']    	 	= $this->crud_model->listar('produtos WHERE categoria = 4 ORDER BY nome ASC');
		$data['list_entrega']  	 	= $this->crud_model->listar('produtos WHERE categoria = 6 ORDER BY nome ASC');
		$data['list_adicionais'] 	= $this->crud_model->listar('produtos WHERE adicional = 1 AND categoria = 5 ORDER BY nome ASC');
		...
		$data['list_pedidos_abertos'] = $this->crud_model->listar('pedidos_espera_html');
		...
		$data['list_config'] = $this->crud_model->listar('config');
