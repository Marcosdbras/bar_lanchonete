        ...
        <div class="body">
            ...
            <div class="col_2" id="lista_produtos">
            	<div class="col_2_row_11">
                	<div id="pesquisa_produtos">
                        Pesquisar Produto <input id="input_pesquisa_produtos" placeholder="Pesquise pelo nome do Produto"/>
                    </div>
                </div>
                <div class="col_2_row_1">
					...
					<?php $cont = $cont +1; ?>
                        <div id="menu_<?php echo $item->alias; ?>" <?php if($cont == 1){echo 'class="menu_select"';} ?>>
                        	<?php echo $item->nome; ?>
                        </div>
					<?php } ?>
                    </div>
                ...
                <div class="col_2_row_2" >                					
					<?php foreach($categorias as $cat){ ?>
						<div id="produtos_<?= $cat->alias ?>" menu="menu_<?= $cat->alias ?>" class="produtos_itens">
						<?php foreach($produtos as $item){ ?>
							<?php if($item->categoria == $cat->id){ ?>
								<div class="produto_item produto_item_click" id="<?= $item->id ?>"  title="<?= $item->descricao ?>">
            ...
            <div class="col_2" id="lista_clientes">
            	<div class="col_2_row_11">
                	<div id="pesquisa_clientes">
                        Pesquisar Cliente <input id="input_pesquisa_clientes" placeholder="Pesquise por Cliente"/>
                    </div>
                </div>
            	<div class="col_2_row_1">
            ...
            <div class="col_2" id="pedidos_em_aberto">
            	<div class="col_2_row_11">
                	...
                	<div id="pesquisa_clientes">
                        Chamar Senha <input id="input_espera_item_chamar" placeholder="Digite o Número e tecle Enter" />
                    </div>
                </div>
                <div class="col_2_row_21">
