        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <input type="hidden" name="action" value="editar"/>
                       ...
                       <span class="field"><input type="text" name="email" class="mediuminput" placeholder="contato@e-bitsistemas.com.br" value="<?php echo $row->email; ?>" required/></span></p>
                       
                       <p><label>Website</label>
                       <span class="field"><input type="text" name="website" class="mediuminput" placeholder="www.e-bitsistemas.com.br" value="<?php echo $row->website; ?>"/></span></p>
